import os
from deepspec.trainer import Qwen3_5DSparkTrainer
BASE_TB_DIR = os.path.expanduser("~/tensorboard")
BASE_CKPT_DIR = os.path.expanduser("~/checkpoints")
project_name = "deepspec"
exp_name = "dspark_qwen35_2b"
seed = 42

model = dict(
    target_model_name_or_path="/Users/kaiser_1/Documents/VTS/AI_race_2026/DeepSpec/models",
    block_size=7,
    num_draft_layers=5,
    target_layer_ids=[1, 6, 11, 16, 21],
    mask_token_id=248055,
    num_anchors=512,
